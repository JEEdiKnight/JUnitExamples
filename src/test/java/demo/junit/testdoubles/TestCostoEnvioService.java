...
public class TestCostoEnvioService {
	...
	public void costoDeEnvioGratuitoParaUSA() {
		...
		// Los tipos doubles tienen problemas de precisión por lo tanto se
		// recomienda
		// usar las siguientes alternativas
		assertEquals(0, costo, DELTA); // Se produce error si la diferencia
										// entre esperado y actual es mayor al
										// delta
